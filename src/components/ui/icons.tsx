/**
 * 인라인 SVG 아이콘 — 전부 장식용(aria-hidden), 색은 currentColor 상속.
 * 의미 전달은 항상 인접 텍스트(배지·레이블)가 담당한다 (색·아이콘 단독 의미 전달 금지).
 */
...
/** 삼각형 느낌표 경고 아이콘 (긴급 배너 20px · 긴급 배지 내 14px) */
