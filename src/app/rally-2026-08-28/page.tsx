...
import { STAGE3_SENTENCE, STAGE3_SENTENCE_CARD, ZONE_STATUS } from "@/lib/rallyMap";
            ...
            <div className="rounded-panel shadow-card mt-6 bg-bg p-5 md:p-8">
              {/*
                ...
                ⚠ **반대로 이 두 가지는 지우지 마라**(요구 160 — 경계):
                  ...
                  **C `※ 지도의 구역 표시는 … 근사 위치입니다`** — §18-1 정밀도 한계(±20~30m)의 문면 이행이다
              ...
              */}
              <p className="mt-1 max-w-[var(--container-prose)] break-keep text-body font-semibold text-ink">
                {ZONE_STATUS.bearing}
              </p>
              {/* 무대 카드와 **같은 상수**에서 나온다(요구 88 · 182) — 카드본은 주어만 붙인 파생이다 */}
              <p className="mt-1 max-w-[var(--container-prose)] break-keep text-body text-ink">
                {STAGE3_SENTENCE}
              </p>
              <p className="mt-3 max-w-[var(--container-prose)] break-keep text-body text-ink">
